...
\location{Starting Sept. 2018 | Edinburgh, UK}
\vspace{\topsep}
...
\end{tightemize}
\location{8.6 / 10 final GPA}
\location{9.0 / 10 BSc thesis}
\vspace{\topsep}

\subsection{Rye High School}
\location{2011 - 2015 | Rye, NY}
\sectionsep
...
\begin{tabulary}{\linewidth}{LLLL}
    & \custombold{Languages} & \custombold{Platforms} & \custombold{Tools} \\
    \hline
    \custombold{Working knowledge} & Python, Java, JavaScript, SQL, Matlab & Flask, Polymer, App Engine, OpenAPI, Bootstrap, Linux, nginx, Docker Compose  & Git, GitHub, IntelliJ, PyCharm \\
    \hline
    \custombold{Experience} & C++, Assembly, Prolog & Java Spark, RobotOS, Mindstorms NXT & Visual Studio
\end{tabulary} 
