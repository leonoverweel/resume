...
\begin{tightemize}
    ...
    \item \href{http://leonoverweel.com/world-port-hackathon-2016}{\custombold{PassPort}} (2016): Blockchain app to detect smuggling in freight containers; 1st-place at World Port Hackathon; presented at I Am Blockchain and BECON conferences; extended into 10-week project at TU Delft.
...
\begin{tabulary}{\linewidth}{LLLL}
    ...
    \hline
    \custombold{Working knowledge} & Python, Java, JavaScript, SQL, Matlab & Flask, App Engine, OpenAPI, Bootstrap, Linux, nginx, Docker Compose, Spotify, Reddit  & Git, GitHub, IntelliJ, PyCharm \\
    \hline
    \custombold{Basic knowledge} & C++, Assembly, Prolog & Java Spark, RobotOS, Mindstorms NXT & Visual Studio \\
\end{tabulary} 
